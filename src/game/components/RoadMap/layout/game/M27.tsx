            ...
            >
                ...
                >
                    ...
                    <text
                        ...
                        fill="white"
                    >
                        {data.filter(({ result }: ResultHaveResultString) => result == 'di').length}
                    </text>
                    <rect
                        width="12"
                        height="12"
                    ...
                    >
                        {
                            data.filter(({ result }: ResultHaveResultString) => result == 'tian')
                                .length
                        }
                    </text>
                    <rect
                            ...
                            <>
                                <g>
                                    ...
                                    <g
                                        ...
                                        clipPath={`url(#${item.idnomor}-${item.di})`}
                                        transform={`translate(${3.5 + this.currentCol! * 14 - (this.firstDisplayedCol || 0) * 16}, ${4.5 + this.currentRow! * 16})`}
                                    >
                                        {item.tian === 'dog' ? (
                                            <Dog color={M27.redColor} />
                                        ) : item.tian === 'dragon' ? (
                                            <Dragon color={M27.redColor} />
                                        ) : item.tian === 'snake' ? (
                                            <Snake color={M27.redColor} />
                                        ) : item.tian === 'rat' ? (
                                            <Rat color={M27.redColor} />
                                        ) : item.tian === 'monkey' ? (
                                            <Monkey color={M27.redColor} />
                                        ) : item.tian === 'rabbit' ? (
                                            <Rabbit color={M27.redColor} />
                                        ) : item.tian === 'ox' ? (
                                            <Ox color={M27.redColor} />
                                        ) : item.tian === 'tiger' ? (
                                            <Tiger color={M27.redColor} />
                                        ) : item.tian === 'pig' ? (
                                            <Pig color={M27.redColor} />
                                        ) : item.tian === 'horse' ? (
                                            <Horse color={M27.redColor} />
                                        ) : item.tian === 'rooster' ? (
                                            <Rooster color={M27.redColor} />
                                        ) : item.tian === 'goat' ? (
                                            <Goat color={M27.redColor} />
                                        ) : null}
                                    </g>
                        ...
                        ele = (
                            <>
                                <g>
                                    ...
                                    >
                                        {item.di === 'dog' ? (
                                            <Dog color={M27.blueColor} />
                                        ) : item.di === 'dragon' ? (
                                            <Dragon color={M27.blueColor} />
                                        ) : item.di === 'snake' ? (
                                            <Snake color={M27.blueColor} />
                                        ) : item.di === 'rat' ? (
                                            <Rat color={M27.blueColor} />
                                        ) : item.di === 'monkey' ? (
                                            <Monkey color={M27.blueColor} />
                                        ) : item.di === 'rabbit' ? (
                                            <Rabbit color={M27.blueColor} />
                                        ) : item.di === 'ox' ? (
                                            <Ox color={M27.blueColor} />
                                        ) : item.di === 'tiger' ? (
                                            <Tiger color={M27.blueColor} />
                                        ) : item.di === 'pig' ? (
                                            <Pig color={M27.blueColor} />
                                        ) : item.di === 'horse' ? (
                                            <Horse color={M27.blueColor} />
                                        ) : item.di === 'rooster' ? (
                                            <Rooster color={M27.blueColor} />
                                        ) : item.di === 'goat' ? (
                                            <Goat color={M27.blueColor} />
                                        ) : null}
                                    </g>
                        ...
                        ele = (
                            <>
                                <g>
                                    ...
                                    >
                                        {item.di === 'dog' ? (
                                            <Dog color={M27.greenColor} />
                                        ) : item.di === 'dragon' ? (
                                            <Dragon color={M27.greenColor} />
                                        ) : item.di === 'snake' ? (
                                            <Snake color={M27.greenColor} />
                                        ) : item.di === 'rat' ? (
                                            <Rat color={M27.greenColor} />
                                        ) : item.di === 'monkey' ? (
                                            <Monkey color={M27.greenColor} />
                                        ) : item.di === 'rabbit' ? (
                                            <Rabbit color={M27.greenColor} />
                                        ) : item.di === 'ox' ? (
                                            <Ox color={M27.greenColor} />
                                        ) : item.di === 'tiger' ? (
                                            <Tiger color={M27.greenColor} />
                                        ) : item.di === 'pig' ? (
                                            <Pig color={M27.greenColor} />
                                        ) : item.di === 'horse' ? (
                                            <Horse color={M27.greenColor} />
                                        ) : item.di === 'rooster' ? (
                                            <Rooster color={M27.greenColor} />
                                        ) : item.di === 'goat' ? (
                                            <Goat color={M27.greenColor} />
                                        ) : null}
                                    </g>
                ...
                this.simpleBigRoad!.forEach((item, idx) => {
                    if (item === 't') this.pushTieDisplay(this.roadmapTiesDisplay!);
                        ...
                        const data = {
                            ...
                            color:
                                item === 'T' ? this.redColor : item === 'D' ? this.blueColor : null,
                            blink: checkLastIdx(this.simpleBigRoad!, idx)
                                ? this.alternatingStyle
                                : 0,
                        };
        ...
        switch (this.props.type) {
            ...
            case 'predictions':
                ...
                const blueElements = [
                    ...
                    (props: any) => (
                        <circle {...{ ...props }} r="3.182" fill={this.blueColor}></circle>
                    ),
                    (props: any) => (
                ...
                const currentPlayer =
                    this.currentType === 'T' ? 'tian' : this.currentType === 'D' ? 'di' : 'tie';
