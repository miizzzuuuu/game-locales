        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        {
                            data.filter(({ result }: ResultHaveResultString) => result == 'dragon')
                                .length
                        }
                    </text>
                    <rect
                    ...
                    >
                        {
                            data.filter(({ result }: ResultHaveResultString) => result == 'tiger')
                                .length
                        }
                    </text>
                    <rect
    ...
    render(): any {
        ...
        switch (this.props.type) {
            case 'bead-road':
                ...
                if (Math.ceil(history.length / 8) >= (this.props.totalColumns || 24)!)
                    this.firstDisplayedCol =
                        Math.ceil(history.length / 8) - (this.props.totalColumns || 24)!;
                ...
                this.simpleBigRoad!.forEach((item, idx) => {
                    if (item === 't') this.pushTieDisplay(this.roadmapTiesDisplay!);
                        ...
                        const data = {
                            ...
                            color:
                                item === 'D' ? this.redColor : item === 'T' ? this.blueColor : null,
