...
const TableBetWild = () => {
    ...
    useEffect(() => {
        if (containerRef.current) {
            containerRef.current!.style.setProperty('--button-bet-width', `${5}vw`);
            containerRef.current!.style.setProperty('--button-bet-height', `${5}vw`);
        }
    }, []);
    ...
    const [tableSection] = useState<'more' | 'less'>('more');
                        ...
                        <ChildBetButton
                            ...
                            bgSvg={(isWin) => (
                                ...
                                >
                                    ...
                                    ></path>
                                    <path
                                        fill="url(#paint1_linear_12_598)"
                                        d="M160 1H171V38H160z"
                                    ></path>
                                    <path
                                        fill="url(#paint2_linear_12_598)"
                                        d="M160 1H171V38H160z"
                                    ></path>
                                    <defs>
                                        <linearGradient
                        ...
                        <ChildBetButton
                            ...
                            bgSvg={(isWin) => (
                                ...
                                >
                                    ...
                                    ></path>
                                    <path
                                        fill="url(#paint1_linear_12_584)"
                                        d="M160 0H171V37H160z"
                                    ></path>
                                    <path
                                        fill="url(#paint2_linear_12_584)"
                                        d="M160 0H171V37H160z"
                                    ></path>
                                    <defs>
                                        <linearGradient
    ...
    return (
        <>
            <div
                ...
                className={[
                    styles.tableBet,
                    betIsOpen ? styles.open : styles.close,
                    deviceClassName,
                    'portrait',
                ].join(' ')}
            >
                    ...
                    {sections[tableSection]({
                        children: (
                            <div className={domainContainerClassName}>
                                <DragonBetButton bet={{ button: 'dragon', group: 'dragon' }} />
                                <div className={styles.domainTie}>
                                    <SuperWildBetButton
                                        bet={{ button: 'superwild', group: 'superwild' }}
                                    />
                                    <TieBetButton bet={{ button: 'tie', group: 'tie' }} />
                                </div>
                                <TigerBetButton bet={{ button: 'tiger', group: 'tiger' }} />
                            </div>
                        ),
                    })}
                </div>
