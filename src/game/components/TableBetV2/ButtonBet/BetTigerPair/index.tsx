...
const BetTigerPair = ({ bet, onClick }: BetButtonIProps) => {
    ...
    return <div onClick={onClick} className={`${styles["bottom"]} ${styles["right"]} ${styles["tiger-pair"]} ${deviceClassName} ${isWin?styles["table-win-blink"]:""} ${isLose?styles["table-lose-opacity"]:""}`}>
