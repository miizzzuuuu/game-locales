...
export class SVGIconSuccess extends SVGRenderer {
  public render(): ReactNode {
    return (
      <>
        <svg width="80" height="80" viewBox="0 0 390 389" fill="none">
          <path
            ...
            stroke="#20AE5C"
            stroke-width="41.6923"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M132.2 187.416L201.687 256.903L368.456 76.2368"
            stroke="#20AE5C"
            stroke-width="41.6923"
            stroke-linecap="round"
            stroke-linejoin="round"
