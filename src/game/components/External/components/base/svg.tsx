    ...
    return (
      <svg width="100%" height="100%" viewBox="0 0 134 41" fill="none">
        ...
        <defs>
          ...
          >
            <stop stop-color="#343650" stop-opacity="0" />
            <stop offset="1" stop-color="#343650" stop-opacity="0.56" />
          </linearGradient>
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color="#343650" stop-opacity="0.22" />
            <stop offset="1" stop-color="#343650" stop-opacity="0.7" />
          </linearGradient>
        </defs>
      </svg>
    ) as React.ReactNode;
